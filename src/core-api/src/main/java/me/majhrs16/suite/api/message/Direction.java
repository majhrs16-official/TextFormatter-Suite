 ...
 * with {@link Kind#INITIATOR}; the broadcast is {@link Kind#OTHERS}.</p>
 */
public final class Direction {
    ...
    /** Name/permission/target qualifier when the kind needs one. */
