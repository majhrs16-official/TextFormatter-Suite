...
public final class Message {
    ...
    public String toJson() {
        ...
        sb.append('{');
        appendJsonField(sb, "id", id.toString());
        appendJsonField(sb, "type", type.name());
        appendJsonField(sb, "sender", sender.name());
        appendJsonField(sb, "direction", direction.toString());
        appendJsonField(sb, "texts", messages.texts());
        appendJsonField(sb, "toolTips", toolTips.texts());
        appendJsonField(sb, "sounds", sounds);
        appendJsonField(sb, "colorMode", colorMode.name());
        appendJsonField(sb, "langSource", langSource != null ? langSource.code() : null);
        appendJsonField(sb, "langTarget", langTarget != null ? langTarget.code() : null);
        appendJsonField(sb, "resolvedSourceLanguage", resolvedSourceLanguage != null ? resolvedSourceLanguage.code() : null);
        appendJsonField(sb, "translate", translate);
        appendJsonField(sb, "cancelled", cancelled);
        appendJsonField(sb, "show", show);
        appendJsonField(sb, "formatPapi", formatPapi);
        appendJsonField(sb, "channel", channel);
        appendJsonField(sb, "sleepMillis", sleepMillis);
        if (sb.length() > 1) sb.setLength(sb.length() - 1);
        sb.append('}');
        return sb.toString();
    }

    private void appendJsonField(StringBuilder sb, String name, Object value) {
