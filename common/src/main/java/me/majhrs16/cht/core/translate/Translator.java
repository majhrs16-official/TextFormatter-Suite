 ...
 *
 * <p>The engine only ever works with language codes (see
 * {@link me.majhrs16.cht.core.language.Language#code()}); a provider may
 * support a different, shorter set than the full catalog.</p>
 */
public interface Translator {
    ...
    /**
     * @return whether the provider can be used right now (e.g. endpoint
