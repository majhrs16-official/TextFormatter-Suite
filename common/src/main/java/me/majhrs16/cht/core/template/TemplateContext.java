...
public final class TemplateContext {
    ...
    public static Builder builder(Subject sender, Language source, Language target) {
    ...
    public static final class Builder {
        ...
        private Builder(Subject sender, Language sourceLanguage, Language targetLanguage) {
            this.sender = sender;
