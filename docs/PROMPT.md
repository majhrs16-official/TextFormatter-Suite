...
- El Manager buscará módulos en el GitHub del proyecto, descargando la versión correspondiente a los módulos actuales (retrocompatibilidad) o la *latest release* en instalaciones nuevas.
